...
LOCK TABLES `ipa` WRITE;
/*!40000 ALTER TABLE `ipa` DISABLE KEYS */;
INSERT INTO `ipa` VALUES ('X IPA',100101,'Sinta'),('X IPA',100102,'Edo'),('X IPA',100103,'Aldo'),('X IPA',100104,'Angga'),('XI IPA',110101,'Pratiwi'),('XI IPA',110102,'Hapsari'),('XI IPA',110103,'Vidi'),('XI IPA',110104,'Rama'),('XII IPA',120101,'Abraham'),('XII IPA',120102,'Adiguna'),('XII IPA',120103,'Kurnia'),('XII IPA',120104,'Tarra');
